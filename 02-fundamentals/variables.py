...
# Zjištění identity objektu (adresa v paměti)
...
'''Úkol B'''
#? Vypište do poznámky všechny bitové operátory, které nabízí Python 1
...
myself_binary = 0b10110
print(int(myself_binary))
x = myself_binary >> 2
print(int(x))
y= x&0x1A
print(int(y))
print("Binární součin čísla {} a {} je {}".format(bin(x),bin(y),bin(x&y)))
